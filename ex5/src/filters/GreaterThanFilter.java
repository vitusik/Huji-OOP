...
/**
 * filter that checks if the file's size is greater than the one that is stored inside the filter
 */
public class GreaterThanFilter extends SizeFilter {
     ...
     */
    public GreaterThanFilter(String string) throws FilterException{
        super(string);
    }

    /**
     * method that checks if the file's size is larger than the stored threshold, if it is then true will
     * be returned
